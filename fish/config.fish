...
alias lal="eza -al --icons --git --group-directories-first --group" # List all files in list format
alias ll="eza -l --icons --git --group-directories-first --group" # List files in list format
